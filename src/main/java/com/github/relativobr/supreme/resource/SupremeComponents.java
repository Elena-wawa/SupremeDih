...
public class SupremeComponents {
  ...
  public static final SlimefunItemStack AURUM_PLATE = new SupremeItemStack("SUPREME_AURUM_PLATE", Material.GOLD_BLOCK,
      "&aAura Monster Plate", "", "&3Supreme Stairs Components");
  ...
  public static final SlimefunItemStack INDUCTIVE_MACHINE = new SupremeItemStack("SUPREME_INDUCTIVE_MACHINE",
      Material.DEAD_FIRE_CORAL_BLOCK, "&aStupid Machine", "", "&3Supreme Advanced Components");
  ...
  public static final SlimefunItemStack INDUCTOR_MACHINE = new SupremeItemStack("SUPREME_INDUCTOR_MACHINE",
      Material.FIRE_CORAL_BLOCK, "&aIndecisive Machine", "", "&3Supreme Advanced Components");
  ...
  public static final SlimefunItemStack RUSTLESS_MACHINE = new SupremeItemStack("SUPREME_RUSTLESS_MACHINE",
      Material.DEAD_BRAIN_CORAL_BLOCK, "&aRustable Machine", "", "&3Supreme Advanced Components");
  ...
  public static final SlimefunItemStack STAINLESS_MACHINE = new SupremeItemStack("SUPREME_STAINLESS_MACHINE",
      Material.BRAIN_CORAL_BLOCK, "&aDefenestration Machine", "", "&3Supreme Advanced Components");
  ...
  public static final SlimefunItemStack CARRIAGE_MACHINE = new SupremeItemStack("SUPREME_CARRIAGE_MACHINE",
      Material.DEAD_HORN_CORAL_BLOCK, "&aAnnoying Machine", "", "&3Supreme Advanced Components");
  ...
  public static final SlimefunItemStack CENTER_CARD_SIMPLE = new SupremeItemStack("SUPREME_CENTER_CARD_SIMPLE",
      Material.MUSIC_DISC_11, "&aBasic Component Card", "", "&fComponent for Machine to produce items", "",
      "&3Supreme Component");
  ...
  public static final SlimefunItemStack CENTER_CARD_ADVANCED = new SupremeItemStack("SUPREME_CENTER_CARD_ADVANCED",
      Material.MUSIC_DISC_PIGSTEP, "&aAdvanced Component Card", "", "&fComponent for Machine to produce items", "",
      "&3Supreme Component");
  ...
  public static final SlimefunItemStack CENTER_CARD_ULTIMATE = new SupremeItemStack("SUPREME_CENTER_CARD_ULTIMATE",
      Material.MUSIC_DISC_MALL, "&aUltimate Component Card", "", "&fComponent for Machine to produce items", "",
      "&3Supreme Component");
  public static final ItemStack[] RECIPE_CENTER_CARD_ULTIMATE = new ItemStack[]{SupremeComponents.PLATINUM_PLATE,
      SupremeComponents.CENTER_CARD_ADVANCED, SupremeComponents.ADAMANTIUM_PLATE, SupremeComponents.CENTER_CARD_ADVANCED,
      Materials.REDSTONE_SINGULARITY, SupremeComponents.CENTER_CARD_ADVANCED, TechGenerator.TECH_GENERATOR,
      SupremeComponents.CENTER_CARD_ADVANCED, TechGenerator.TECH_GENERATOR};
  ...
  public static final SlimefunItemStack DUST_AMETHYST = new SupremeItemStack("SUPREME_DUST_AMETHYST",
      Material.BEETROOT_SEEDS, "&aAmethyst Dih", "", "&3Supreme Component");
